...
# Collections — use cosine distance, no embeddings needed (we store docs + query by text)
...
def simple_embed(text: str) -> list[float]:
    ...
    Produces a 256-dim float vector — good enough for keyword-style retrieval
